...
const Layout = ({ children, isLoggedIn, onLogout }: LayoutProps) => {
  ...
  const handleLogin = () => {
    loginWithRedirect({ 
      appState: { 
        returnTo: location.pathname === "/" ? "/home" : location.pathname 
      }
    });
  };
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          {!isLoggedIn ? (
            <div className="flex justify-center space-x-8">
              <Link to="/home" className="text-white font-medium hover:text-blue-200 transition-colors duration-200 px-4 py-2 rounded-lg hover:bg-white/10">
                Home
              </Link>
              <Link to="/about" className="text-white font-medium hover:text-blue-200 transition-colors duration-200 px-4 py-2 rounded-lg hover:bg-white/10">
                About
              </Link>
            ...
            <div className="flex justify-center items-center space-x-6">
              <Link to="/home" className="text-white font-medium hover:text-blue-200 transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/10">Home</Link>
              <Link to="/about" className="text-white font-medium hover:text-blue-200 transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/10">About</Link>
              <Link to="/profile" className="text-white font-medium hover:text-blue-200 transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/10">Profile</Link>
              <Link to="/event-management" className="text-white font-medium hover:text-blue-200 transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/10">Event Management</Link>
